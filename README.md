...
This section sets the geometry of the box. Required parameters are the box dimensions **LX**, **LY**, **LZ**. Optional parameters depend on system type with the previous section. 
...
- With the parameter **NEWBOX** you can increase the box dimensions *LX LY LZ*.
...
| Simulation step 1 name  | parameter1 | parameter2 | parameter3 | parameter4 |   ...   |
|:------------------------|:-----------|:-----------|:-----------|:-----------| **...** |
|                         |   value1   |   value2   |   value3   |   value4   |   ...   |
| Simulation step 2 name  | parameter1 | parameter2 | parameter3 | parameter4 |   ...   |
|:------------------------|:-----------|:-----------|:-----------|:-----------| **...** |
|                         |   value1   |   value2   |   value3   |   value4   |   ...   |
